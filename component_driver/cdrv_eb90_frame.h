...
#define CDRV_EB90_FRAME_STX_SIZE     (2)           //!< EB90 Frame の STX のサイズ
#define CDRV_EB90_FRAME_ETX_SIZE     (2)           //!< EB90 Frame の ETX のサイズ
#define CDRV_EB90_FRAME_LEN_SIZE     (2)           //!< EB90 Frame の LEN のサイズ
#define CDRV_EB90_FRAME_CRC_SIZE     (2)           //!< EB90 Frame の CRC のサイズ
#define CDRV_EB90_FRAME_HEADER_SIZE  (CDRV_EB90_FRAME_STX_SIZE + CDRV_EB90_FRAME_LEN_SIZE)  //!< EB90 Frame のヘッダサイズ
#define CDRV_EB90_FRAME_FOOTER_SIZE  (CDRV_EB90_FRAME_ETX_SIZE + CDRV_EB90_FRAME_CRC_SIZE)  //!< EB90 Frame のフッタサイズ

#define CDRV_EB90_FRAME_STX_1ST_BYTE     (0xEB)    //!< EB90 Frame の STX 1st byte
#define CDRV_EB90_FRAME_STX_2ND_BYTE     (0x90)    //!< EB90 Frame の STX 2nd byte
#define CDRV_EB90_FRAME_ETX_1ST_BYTE     (0xC5)    //!< EB90 Frame の ETX 1st byte
#define CDRV_EB90_FRAME_ETX_2ND_BYTE     (0x79)    //!< EB90 Frame の ETX 2nd byte

extern const uint8_t CDRV_EB90_FRAME_kStx[CDRV_EB90_FRAME_STX_SIZE];
extern const uint8_t CDRV_EB90_FRAME_kEtx[CDRV_EB90_FRAME_ETX_SIZE];
