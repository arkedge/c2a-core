...
def GenerateTlmBuffer(settings, other_obc_dbs):
    ...
    for i in range(len(settings["other_obc_data"])):
        ...
        for tlm in tlm_db:
            ...
            body_c += (
                "static FRM_ERR_CODE {_obc_name_upper}_analyze_tlm_"
                + tlm_name_lower
        ...
        body_h += "\n"
        body_h += (
            "FRM_ERR_CODE {_obc_name_upper}_buffer_tlm_packet(FRM_StreamConfig* p_stream_config, "
            + driver_type
            + "* "
            + driver_name
            + ");\n"
        ...
        body_c += "    return FRM_ERR_CODE_ERR;\n"
        body_c += "  }}\n"
        body_c += "}}\n"
        body_c += "\n"
        for tlm in tlm_db:
