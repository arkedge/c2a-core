 ...
 */
CDS_ERR_CODE I2C_write_byte(DriverSuper* p_super, uint8_t stream, I2C_Config* p_i2c_config,
 ...
 * @retval CDS_ERR_CODE (CDS_send_general_cmd の返り値)
 */
CDS_ERR_CODE I2C_write_2bytes(DriverSuper* p_super, uint8_t stream, I2C_Config* p_i2c_config,
