 ...
 */
FRM_ERR_CODE I2C_write_byte(Framing* p_framing, uint8_t stream, I2C_Config* p_i2c_config,
 ...
 * @retval FRM_ERR_CODE (FRM_send_general_cmd の返り値)
 */
FRM_ERR_CODE I2C_write_2bytes(Framing* p_framing, uint8_t stream, I2C_Config* p_i2c_config,
