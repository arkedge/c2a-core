 ...
 */
static FRM_ERR_CODE I2C_write_bytes_(Framing* p_super, uint8_t stream, I2C_Config* p_i2c_config,
 ...
 * @retval FRM_ERR_CODE
 */
static FRM_ERR_CODE I2C_read_bytes_(Framing* p_super, uint8_t stream, I2C_Config* p_i2c_config,
                                   uint8_t register_address, void* data_v, uint8_t buffer_size);

FRM_ERR_CODE I2C_write_byte(Framing* p_super, uint8_t stream, I2C_Config* p_i2c_config, uint8_t register_address, uint8_t data)
{
  return I2C_write_bytes_(p_super, stream, p_i2c_config, register_address, &data, sizeof(data));
}

FRM_ERR_CODE I2C_write_2bytes(Framing* p_super, uint8_t stream, I2C_Config* p_i2c_config, uint8_t register_address, uint16_t data)
{
  return I2C_write_bytes_(p_super, stream, p_i2c_config, register_address, &data, sizeof(data));
}
