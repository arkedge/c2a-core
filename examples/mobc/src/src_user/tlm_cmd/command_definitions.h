...
typedef enum
{
  ...
  Cmd_CODE_CDRV_UTIL_HAL_INIT = 0x0096,
  Cmd_CODE_CDRV_UTIL_HAL_RX = 0x0097,
  Cmd_CODE_CDRV_UTIL_HAL_TX = 0x0098,
  Cmd_CODE_CDRV_UTIL_HAL_REOPEN = 0x0099,
  Cmd_CODE_CDRV_UTIL_HAL_RX_TO_RAM = 0x009A,
  Cmd_CODE_CDRV_UTIL_HAL_TX_FROM_RAM = 0x009B,
  Cmd_CODE_CDRV_UTIL_HAL_CLEAR_RX_BUFFER = 0x009C,
  Cmd_CODE_CDRV_UTIL_SET_TLM = 0x009D,
  Cmd_CODE_TEST_CCP_REGISTER_TLC_ASAP = 0x009E,
  Cmd_CODE_TEST_CCP_GET_RAW_PARAM_INFO = 0x009F,
