...
## c2a user code
git mv src/src_user/IfWrapper/Common src/src_user/hal/common
git mv src/src_user/IfWrapper/Sils src/src_user/hal/sils
git mv src/src_user/IfWrapper/SilsMockup src/src_user/hal/sils_mockup
git mv src/src_user/IfWrapper src/src_user/hal
