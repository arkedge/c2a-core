...
uint32_t EB90_PACKET_get_version_from_dssc(const FRM_StreamConfig* p_stream_config)
{
...
uint32_t EB90_PACKET_get_count_from_dssc(const FRM_StreamConfig* p_stream_config)
{
...
uint32_t EB90_PACKET_get_id_from_dssc(const FRM_StreamConfig* p_stream_config)
{
  const uint32_t version = EB90_PACKET_get_version_from_dssc(p_stream_config);
...
const uint8_t* EB90_PACKET_get_user_data_head_from_dssc(const FRM_StreamConfig* p_stream_config)
{
  const uint32_t version = EB90_PACKET_get_version_from_dssc(p_stream_config);
