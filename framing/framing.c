 ...
 */
static DS_ERR_CODE DS_send_cmd_(Framing* p_super, uint8_t stream);
 ...
 */
static int DS_tx_(Framing* p_super, uint8_t stream);
 ...
 * @retval 負数: IF_RXのエラー
 */
static int DS_rx_(Framing* p_super);

/**
 * @brief  受信フレーム解析関数
 * @param[in]  p_stream_config: Framing 構造体の DS_StreamConfig
 ...
 * @return DS_ERR_CODE
 */
static DS_ERR_CODE DS_validate_stream_config_(const Framing* p_super, DS_StreamConfig* p_stream_config);

// ダミー関数
// EQU だと関数ポインタの初期値を NULL にしていたためにぬるぽで事故ったので
static DS_ERR_CODE DS_load_init_setting_dummy_(Framing* p_super);
...
DS_ERR_CODE DS_init(Framing* p_super,
                    void* if_config,
                    DS_StreamRecBuffer* rx_buffer,
                    DS_ERR_CODE (*load_init_setting)(Framing* p_super))
{
...
DS_ERR_CODE DS_init_streams(Framing* p_super,
                            void* if_config,
                            DS_StreamRecBuffer* rx_buffers[DS_STREAM_MAX],
                            DS_ERR_CODE (*load_init_setting)(Framing* p_super))
{
...
DS_ERR_CODE DS_reset(Framing* p_super)
{
  uint8_t stream;
...
DS_ERR_CODE DS_validate_config(Framing* p_super)
{
  uint8_t stream;
...
DS_ERR_CODE DS_clear_rx_buffer(Framing* p_super)
{
  uint8_t stream;
...
DS_ERR_CODE DS_receive(Framing* p_super)
{
  uint8_t  stream;
  uint16_t rec_data_len;
  int      ret_rx;
...
DS_ERR_CODE DS_analyze_rec_data(Framing* p_super, uint8_t stream, void* p_driver)
{
  DS_StreamConfig* p_stream_config = &(p_super->stream_config[stream]);
...
DS_ERR_CODE DS_send_general_cmd(Framing* p_super, uint8_t stream)
{
  DS_StreamConfig* p_stream_config = &(p_super->stream_config[stream]);
...
DS_ERR_CODE DS_send_req_tlm_cmd(Framing* p_super, uint8_t stream)
{
  DS_StreamConfig* p_stream_config = &(p_super->stream_config[stream]);
...
DS_ERR_CODE DSC_set_rx_buffer_size_in_if_rx(Framing* p_super,
...
const DS_RecStatus* DSC_get_rec_status(const Framing* p_super)
{
...
DS_RX_DISRUPTION_STATUS_CODE DSC_get_rx_disruption_status(const Framing* p_super)
{
